...
const medicalPlanningServiceData = [
  '平台可以提供专业的就医规划咨询服务，包括但不限于:梳理问诊思路，疑难病理指导，难治病情分析',
];
...
const proxyConsultationServiceData = [
  {
    ...
    items: [
      {
        title: '1、诊前咨询：',
        description: '用户提前与顾问沟通，了解代问诊内容、服务流程、收费标准；患者写清具体病史、病况及问诊需求，准备病案材料，近期检查资料；确认代问诊时间及医院地点等事宜，由委托人填写代问诊申请表，以便问诊专员为患者提供代问诊服务。诊前准备',
      },
       {
        title: '2、诊前资料准备：',
